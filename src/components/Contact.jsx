...
import { Stars, Tube } from "@react-three/drei";
...
const formRef = useRef();
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_yx08i4s', 'template_s8x9mok',
     {
       form_name: form.name,
       to_name: 'M.J',
       form_email: form.email,
       to_email: 'im6s@icloud.com',
    ...
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      >
       <label className="flex flex-col">
        ...
        font-bold shadow-md  shadow-white rounded-xl">
